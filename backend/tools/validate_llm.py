...
Usage:
    ...
    uv run python tools/validate_llm.py --endpoint http://local-gpu:8000/v1 --model gpt-oss-120b --scenario text
...
def load_configured_endpoints() -> list[dict]:
    ...
    well_known = [
        {"name": "vLLM (local-gpu)", "url": "http://local-gpu:8000/v1", "model": "gpt-oss-120b", "api_key": None},
