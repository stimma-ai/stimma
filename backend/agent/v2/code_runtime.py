...
class StimmaSDK:
    ...
    async def create_parameter_sweep(
        ...
        Creates a .stimmagrid.json MediaItem. Final presentation promotes the
        grid as one Asset; bare intermediate cells stay embedded, while cells
        that already have Asset identity remain independent.
