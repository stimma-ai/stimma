...
evaluator. For Phase 2 we keep this indirection small and testable:
  ...
  - production wiring (done in Phase 3 when we wire the flow agent) will
...
class EvaluatorError(RuntimeError):
    ...
    Categories follow FLOWS_TECH.md §Error Handling:
      ...
      - resource       (pause flow — out of credits, disk)
    """
...
RETRY_POLICY = {
    ...
    RESOURCE_ERROR: 0,  # pause the flow (handled by runtime)
