...
def test_create_package_registers_one_equation():
    ...
    assert eq.definition["params"] == {"platforms": ["ios"]}
...
def test_create_package_rejects_node_params():
    ...
    def r():
        with phase("P"):
            ...
            return create_package(
                members, recipe="app-icons", params={"platforms": sizes},
            )
