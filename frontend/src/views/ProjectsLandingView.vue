    ...
    <div class="flex items-center justify-between border-b border-edge-subtle px-6 py-5">
      ...
      <div class="flex items-center gap-3">
        ...
        <input
          ...
          class="w-52 rounded-lg border border-edge-subtle bg-overlay-subtle py-1.5 pl-9 pr-3 text-sm text-content-secondary placeholder-white/30 focus:border-blue-500/50 focus:outline-none"
        />
      </div>
      </div>
    </div>
