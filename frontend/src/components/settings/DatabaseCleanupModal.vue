<template>
  <Modal
    :show="show"
    size="custom"
    custom-class="max-w-[95vw] w-[860px] max-h-[90vh] flex flex-col overflow-hidden"
  ...
  >
    <template #header>
      <div class="flex items-start justify-between">
        ...
        <IconButton aria-label="Close database maintenance" title="Close" :disabled="busy" @click="close">
    ...
    <template #footer>
      ...
      <Button variant="primary" :disabled="busy" @click="maintenance.analyzeDatabase()">
