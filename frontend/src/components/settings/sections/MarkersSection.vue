    ...
    <Teleport to="body">
      ...
      >
        <button
          ...
          class="w-full flex items-center gap-2 px-3 py-2 text-sm text-content hover:bg-surface-raised disabled:opacity-40 disabled:cursor-not-allowed transition-colors text-left"
        >
