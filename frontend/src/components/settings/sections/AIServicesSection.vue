          ...
          <div class="px-6 py-4">
            <div class="space-y-4">
              <label class="block">
                ...
                <input v-model="addDraft.name" class="w-full rounded-md border border-edge bg-surface-raised px-3 py-2 text-sm text-content focus:border-accent focus:outline-none" placeholder="Home server" />
              </label>
              <label class="block">
