      ...
      <div class="flex gap-1.5">
        <template v-for="mediaId in mediaIds" :key="mediaId">
          ...
          <div
            ...
            class="strip-thumbnail flex-shrink-0 rounded-media bg-matte flex items-center justify-center"
          >
          ...
          <MediaImage
            ...
            :thumbnail="true"
            :thumbnail-size="96"
            container-class="strip-thumbnail flex-shrink-0 rounded-media cursor-pointer hover:ring-2 hover:ring-accent-selection transition-colors"
