...
const groupIsEchoed = computed<boolean>(() =>
  flowRefs.hoveredRefKey.value === groupRefKey.value,
)
...
const STATUS_CLASS: Record<string, string> = {
  completed: 'bg-flow-done-strong',
  computing: 'bg-flow-run-strong',
  awaiting_input: 'bg-flow-await-strong',
  failed: 'bg-flow-fail-strong',
