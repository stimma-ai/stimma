...
// Global audio-channel mute/volume, shared across all audio players and persisted
const { audioMuted: isMuted, audioVolume: volume, toggleAudioMute } = useMediaPlayback()
// Registry wiring: pause on KeepAlive deactivate (this element loops, so a
// cached view would otherwise keep playing forever), tear down on unmount
