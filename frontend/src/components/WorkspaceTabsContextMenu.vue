<template>
  <Teleport to="body">
    ...
    <div
      ...
      ref="menuRef"
      class="fixed bg-surface border border-edge-subtle rounded-lg shadow-lg z-menu py-1 min-w-[210px]"
      :style="menuStyle"
    >
      <!-- Pin / Unpin -->
      <button
      ...
      <template v-if="contextMenu.state.value.tabType === 'tool'">
        ...
        <button
          ...
          class="w-full px-3 py-2 text-left text-xs text-content hover:bg-overlay-subtle flex items-start gap-2"
        >
