<template>
  <div class="recipe-input-form space-y-3" @keydown.capture="onCommitShortcut">
    <div v-if="fields.length === 0" class="text-[12px] text-content-muted italic">
      This recipe has no inputs yet. Ask the assistant to add the inputs you want to vary.
    </div>
