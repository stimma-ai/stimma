...
export const TASK_TYPE_ICON_SVGS: Record<string, string> = {
  ...
  'erase-image': '<path d="M8.5 20.5L3.9 15.9a1.6 1.6 0 0 1 0-2.3L13.6 4a1.6 1.6 0 0 1 2.3 0l4.2 4.2a1.6 1.6 0 0 1 0 2.3l-10 10z"/><path d="M8.5 9.2l6.3 6.3"/><path d="M9 20.5h11"/>',
  ...
  'reference-to-video': '<rect x="2.5" y="6" width="15" height="12" rx="2"/><path d="M17.5 10l4-2.5v9l-4-2.5z"/><path d="M5.5 9h3M5.5 12h5M5.5 15h3"/>',
  ...
  'process-image': '<rect x="3" y="3" width="18" height="18" rx="2.5"/><path d="M12 7.2l1.25 3.55L16.8 12l-3.55 1.25L12 16.8l-1.25-3.55L7.2 12l3.55-1.25z" fill="currentColor" stroke="none"/>',
...
export const TASK_TYPE_ICON_PATHS: Record<string, string> = {
  ...
  'erase-image': 'm12 12.75 4.5-4.5m-9.44 9.44 10.6-10.6a1.6 1.6 0 0 1 2.27 0l2.37 2.37a1.6 1.6 0 0 1 0 2.27L11.7 20.25H7.06l-3.32-3.32a1.6 1.6 0 0 1 0-2.27ZM9 20.25h11.25',
  ...
  'reference-to-video': 'm15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25h-9A2.25 2.25 0 0 0 2.25 7.5v9a2.25 2.25 0 0 0 2.25 2.25Z',
  ...
  'process-image': 'M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z',
...
export const TASK_TYPE_GRADIENT_CLASSES: Record<string, string> = {
  ...
  'erase-image': 'bg-gradient-to-br from-fuchsia-500/80 to-fuchsia-700/80',
  ...
  'reference-to-video': 'bg-gradient-to-br from-teal-500/80 to-teal-700/80',
  ...
  'process-image': 'bg-gradient-to-br from-red-500/80 to-rose-700/80',
